    ...
    <div class="flex-1 overflow-auto">
      {#if selectedRoute}
          ...
          <div class="max-w-full overflow-x-auto">
            <div class="min-w-0">
              <StatusBodyTab
                ...
                statusCode={selectedRoute.responses[0]?.statusCode}
        ...
        {:else if activeContentTab === "Rules"}
          <RulesTab rules={selectedRoute.responses[0] && 'rules' in selectedRoute.responses[0] ? (selectedRoute.responses[0] as any).rules : []} />
        {:else if activeContentTab === "Callbacks"}
          <div class="max-w-full overflow-x-auto">
            <div class="min-w-0">
              <CallbacksTab callbacks={selectedRoute.responses[0] && 'callbacks' in selectedRoute.responses[0] ? (selectedRoute.responses[0] as any).callbacks : []} />
            </div>
          </div>
        {/if}
      {:else}
